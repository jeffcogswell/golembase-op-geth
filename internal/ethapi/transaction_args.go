...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/jeffcogswell/golembase-op-geth/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/jeffcogswell/golembase-op-geth/pull/23274
